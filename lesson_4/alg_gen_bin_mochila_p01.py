...
# p01_s.txt (solução ótima conhecida)
SOLUCAO_OTIMA = [1,1,1,1,0,1,0,0,0,0]
...
print("\n--- Solução ótima conhecida da instância p01 ---")
...
plt.xlabel("Geração")
plt.ylabel("Fitness")
plt.title("Convergência do fitness - Mochila Binária (p01)")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

plt.savefig("grafico_fitness_mochila_p01.png", dpi=300)
plt.close()
...
plt.title("Convergência do valor total - Mochila Binária (p01)")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

plt.savefig("grafico_valor_mochila_p01.png", dpi=300)
plt.close()
...
plt.title("Evolução do peso da melhor solução - Mochila Binária (p01)")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()

plt.savefig("grafico_peso_mochila_p01.png", dpi=300)
plt.close()

print("\nGráficos salvos com sucesso:")
print(" - grafico_fitness_mochila_p01.png")
print(" - grafico_valor_mochila_p01.png")
print(" - grafico_peso_mochila_p01.png")